...
//default routes
Router.route("/").get((0, schemavalidator_middleware_1.default)(product_schema_1.getAllProductListSchema), product_controller_1.getAllProductList).post((0, schemavalidator_middleware_1.default)(product_schema_1.addProdutSchema), product_controller_1.addNewProduct);
//paramterized routes
