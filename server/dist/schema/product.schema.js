...
exports.addProdutSchema = (0, zod_1.object)({
    body: (0, zod_1.object)({
        ...
        subCategory: (0, zod_1.array)((0, zod_1.string)({})).nonempty({ message: "Subcategory must be at least 1 item" }),
        images: (0, zod_1.array)((0, zod_1.string)({})).nonempty({ message: "1 or more images need to add " }).optional(),
